  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-semibold font-body ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom hero variants
        hero: "bg-primary text-primary-foreground hover:bg-primary-hover shadow-teal hover:shadow-elevated text-base",
        heroOutline: "border-2 border-primary-foreground text-primary-foreground bg-transparent hover:bg-primary-foreground/10 text-base",
        // CTA variants
        cta: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-sm",
      },
      size: {
